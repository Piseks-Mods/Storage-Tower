...
public class StorageCraftingControllerScreen extends AbstractContainerScreen<StorageCraftingControllerMenu> {
    ...
    protected void renderBg(GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        pGuiGraphics.fill(x + 7, y + 17, x + 169, y + 55, menu.getClientTotalSlots() > 0 ? 0xFF935A10 : 0xFF8B8B8B);
        ...
        pGuiGraphics.fill(x + 52, y + 57, x + 106, y + 111, menu.getClientTotalSlots() > 0 ? 0xFF935A10 : 0xFF8B8B8B);
        ...
        pGuiGraphics.fill(x + 142, y + 72, x + 160, y + 90, menu.getClientTotalSlots() > 0 ? 0xFF935A10 : 0xFF8B8B8B);
        pGuiGraphics.fill(x + 143, y + 73, x + 159, y + 89, menu.getClientTotalSlots() > 0 ? 0xFFCE954B : 0xFFC6C6C6);
    }
