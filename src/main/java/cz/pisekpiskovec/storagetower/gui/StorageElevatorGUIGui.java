...
import cz.pisekpiskovec.storagetower.procedures.StorageElevatorUpProcedure;
import cz.pisekpiskovec.storagetower.procedures.StorageElevatorDownProcedure;
...
public class StorageElevatorGUIGui extends PiseksStorageTowerModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public StorageElevatorGUIGui(PiseksStorageTowerModElements instance) {
		super(instance, 18);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("storage_elevator_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, StorageElevatorGUIGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			StorageElevatorUpProcedure.executeProcedure(Stream
		...
		if (buttonID == 1) {
			...
			StorageElevatorDownProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
